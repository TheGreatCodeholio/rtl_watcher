...
module_logger = logging.getLogger('rtl_watcher.tone_detect')


def get_tones(tone_detect_config, mp3_file_path):
    detected_tones = {
        "two_tone": [],
        "long_tone": [],
        "hi_low_tone": []
